...
class Paddle {
	public:
		...
		float3 move( const int x, const int y, const bool spherical = false, const float stepping =  .25f ) ;
		float3 roll( const int s,              const bool spherical = false, const float stepping = 2.f   ) ;
