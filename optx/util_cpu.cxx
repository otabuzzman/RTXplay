...
void optxInitialize( const SbtRecordRG& camera, const SbtRecordMS& ambient ) noexcept( false ) {
	...
	optx_state.sbt_record_camera  = camera ;
	optx_state.sbt_record_ambient = ambient ;
}
